...
def check_participant():
    ...
    tts.say("Before we start, I want to make sure you are ready. \
         If you want to particicpate in the game, please stand in front of me and rise your hand.")
    msg = []
    if conn.poll(0):
        msg=conn.recv()
    ...
    msg = conn.recv()
    if msg[0] == "gamer":
        tts.say("Great! Let's start the game.")
        return True
